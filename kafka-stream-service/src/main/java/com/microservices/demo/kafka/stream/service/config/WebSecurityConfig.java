...
import com.microservices.demo.kafka.stream.service.security.KafkaStreamUserDetailsService;
import com.microservices.demo.kafka.stream.service.security.KafkaStreamsUserJwtConverter;
...
public class WebSecurityConfig {
    ...
    private final KafkaStreamUserDetailsService kafkaStreamsUserDetailsService;
    ...
    public WebSecurityConfig(KafkaStreamUserDetailsService kafkaStreamsUserDetailsService,
    ...
    @Bean
    JwtDecoder jwtDecoder(@Qualifier("kafka-stream-service-audience-validator")
