...
import static com.microservices.demo.kafka.stream.service.Constants.NA;
...
public class KafkaStreamsUserJwtConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public KafkaStreamsUserJwtConverter(KafkaStreamUserDetailsService kafkaStreamsUserDetailsService) {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        return Optional.ofNullable(
                ...
                .map(userDetails -> {
                    ((KafkaStreamUser) userDetails).setAuthorities(authoritiesFromJwt);
