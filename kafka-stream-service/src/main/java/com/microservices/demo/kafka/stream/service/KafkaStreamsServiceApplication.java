package com.microservices.demo.kafka.stream.service;

import com.microservices.demo.kafka.stream.service.runner.StreamRunner;
import com.microservices.demo.kafka.stream.service.init.StreamsInitializer;
import com.microservices.demo.kafka.stream.service.runner.StreamRunner;
...
public class KafkaStreamsServiceApplication implements CommandLineRunner {
	...
	private final StreamRunner<String, Long> streamsRunner;

	private final StreamsInitializer streamsInitializer;

	public KafkaStreamsServiceApplication(StreamRunner<String, Long> runner,
