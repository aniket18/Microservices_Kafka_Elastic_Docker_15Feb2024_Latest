...
import com.microservices.demo.config.KafkaStreamServiceConfigData;
...
@Qualifier(value = "kafka-stream-service-audience-validator")
@Component
public class AudienceValidator implements OAuth2TokenValidator<Jwt> {

    private final KafkaStreamServiceConfigData kafkaStreamsServiceConfig;

    public AudienceValidator(KafkaStreamServiceConfigData config) {
